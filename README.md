...
│   │   ├── simple_admin.py  # Админ панель
│   │   ├── questions.py     # Q&A система
...
## 📊 Аналитика ⚠️ **НЕ РАБОТАЕТ**

> **ВНИМАНИЕ**: Модуль аналитики (`app/orders/analytics.py`) содержит критические ошибки и требует полной переработки. Будет исправлен в следующих версиях.

### Проблемы модуля:
- ❌ Ошибки в методах `get_analytics_by_departments()`, `get_top_products()`, `get_top_ambassadors()`
- ❌ Некорректная обработка данных статистики
- ❌ Неработающие обработчики аналитики
